...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/graficos/medicos.png}
  \caption{Relación entre el número de médicos, el tiempo de espera, la tasa de abandono y el uso de médicos.}
  \label{fig:medicos_metricas}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/graficos/abandono.png}
  \caption{Impacto de la tasa de llegadas en el tiempo de espera y la tasa de abandono.}
  \label{fig:tasa_llegadas_metricas}
\end{figure}
